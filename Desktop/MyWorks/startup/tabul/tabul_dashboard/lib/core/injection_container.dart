...
Future<void> _initUseCases() async {
  ...
  sl.registerLazySingleton<CreateAdmin>(
    () => CreateAdmin(sl<AuthRepository>()),
  );
  sl.registerLazySingleton<CreateQuickAdmin>(
    () => CreateQuickAdmin(sl<AuthRepository>()),
  );
  sl.registerLazySingleton<RegisterUser>(
    () => RegisterUser(sl<AuthRepository>()),
  );
  sl.registerLazySingleton<GetAllAdmins>(
    () => GetAllAdmins(sl<AuthRepository>()),
  );
  sl.registerLazySingleton<GetUserByUsername>(
    () => GetUserByUsername(sl<AuthRepository>()),
  );
