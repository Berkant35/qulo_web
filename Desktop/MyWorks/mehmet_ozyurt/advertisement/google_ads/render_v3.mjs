...
const templateMap = { square: 'templates/square_v3.html', portrait: 'templates/portrait_v3.html', landscape: 'templates/landscape_v3.html' };
async function run() {
  ...
  await browser.close();
  console.log('Done! Output in output3/');
}
