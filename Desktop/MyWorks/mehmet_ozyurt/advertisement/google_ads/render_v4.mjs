...
const outputDir = path.join(__dirname, 'output4');
if (!fs.existsSync(outputDir)) fs.mkdirSync(outputDir, { recursive: true });
const templateMap = { square: 'templates/square_v4.html', portrait: 'templates/portrait_v4.html', landscape: 'templates/landscape_v4.html' };
async function run() {
