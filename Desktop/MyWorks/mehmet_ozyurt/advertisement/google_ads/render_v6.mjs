...
const outputDir = path.join(__dirname, 'output6');
if (!fs.existsSync(outputDir)) fs.mkdirSync(outputDir, { recursive: true });
const templateMap = { square: 'templates/square_v6.html', portrait: 'templates/portrait_v6.html', landscape: 'templates/landscape_v6.html' };
async function run() {
