...
import '../../models/enums/preferences_key_enum.dart';
...
class LocaleManager {
  ...
  Future<bool> setStringList(PreferencesKeys key, List<String> value) async {
    await _preferences!.setStringList(key.name, value);
    return true;
  }

  Future<List<String>> getStringList(PreferencesKeys key) async {
