...
export const ABOUT_FAQS: FAQLocaleMap = {
  en: [
    ...
    { q: "Where can I use Qulo, and in which languages?", a: "Qulo works wherever the App Store or Google Play is available. The app is in 18 languages: Turkish, English, German, French, Spanish, Arabic, Russian, Portuguese, Italian, Japanese, Korean, Chinese, Dutch, Polish, Swedish, Hindi, Thai and Indonesian." },
  ...
  tr: [
    ...
    { q: "Qulo'yu nerede ve hangi dillerde kullanabilirim?", a: "Qulo, App Store ya da Google Play'in kullanılabildiği her yerde çalışır. Uygulama 18 dilde: Türkçe, İngilizce, Almanca, Fransızca, İspanyolca, Arapça, Rusça, Portekizce, İtalyanca, Japonca, Korece, Çince, Felemenkçe, Lehçe, İsveççe, Hintçe, Tayca ve Endonezce." },
  ...
  fr: [
    ...
    { q: "Où et dans quelles langues puis-je utiliser Qulo ?", a: "Qulo fonctionne partout où l'App Store ou Google Play est disponible. L'application existe en 18 langues : turc, anglais, allemand, français, espagnol, arabe, russe, portugais, italien, japonais, coréen, chinois, néerlandais, polonais, suédois, hindi, thaï et indonésien." },
  ...
  es: [
    ...
    { q: "¿Dónde y en qué idiomas puedo usar Qulo?", a: "Qulo funciona allí donde estén disponibles la App Store o Google Play. La app está en 18 idiomas: turco, inglés, alemán, francés, español, árabe, ruso, portugués, italiano, japonés, coreano, chino, neerlandés, polaco, sueco, hindi, tailandés e indonesio." },
  ...
  ar: [
    ...
    { q: "أين يمكنني استخدام Qulo وبأي لغات؟", a: "يعمل Qulo في كل مكان يتوفر فيه App Store أو Google Play. والتطبيق متاح بثماني عشرة لغة: التركية والإنجليزية والألمانية والفرنسية والإسبانية والعربية والروسية والبرتغالية والإيطالية واليابانية والكورية والصينية والهولندية والبولندية والسويدية والهندية والتايلاندية والإندونيسية." },
  ...
  pt: [
    ...
    { q: "Onde e em quais idiomas posso usar o Qulo?", a: "O Qulo funciona onde houver App Store ou Google Play. O app está em 18 idiomas: turco, inglês, alemão, francês, espanhol, árabe, russo, português, italiano, japonês, coreano, chinês, neerlandês, polonês, sueco, hindi, tailandês e indonésio." },
  ...
  it: [
    ...
    { q: "Dove e in quali lingue posso usare Qulo?", a: "Qulo funziona ovunque siano disponibili App Store o Google Play. L'app è in 18 lingue: turco, inglese, tedesco, francese, spagnolo, arabo, russo, portoghese, italiano, giapponese, coreano, cinese, olandese, polacco, svedese, hindi, thailandese e indonesiano." },
  ...
  ja: [
    ...
    { q: "Quloはどこで、何語で使えますか？", a: "App StoreまたはGoogle Playが使える場所ならどこでも利用できます。アプリは18の言語に対応しています。トルコ語、英語、ドイツ語、フランス語、スペイン語、アラビア語、ロシア語、ポルトガル語、イタリア語、日本語、韓国語、中国語、オランダ語、ポーランド語、スウェーデン語、ヒンディー語、タイ語、インドネシア語です。" },
  ...
  ko: [
    ...
    { q: "Qulo는 어디서, 어떤 언어로 쓸 수 있나요?", a: "App Store나 Google Play를 이용할 수 있는 곳이면 어디서나 쓸 수 있습니다. 앱은 18개 언어를 지원합니다. 터키어, 영어, 독일어, 프랑스어, 스페인어, 아랍어, 러시아어, 포르투갈어, 이탈리아어, 일본어, 한국어, 중국어, 네덜란드어, 폴란드어, 스웨덴어, 힌디어, 태국어, 인도네시아어입니다." },
  ...
  zh: [
    ...
    { q: "Qulo 在哪里、用什么语言可以使用？", a: "只要能用 App Store 或 Google Play 的地方都可以使用。应用支持 18 种语言：土耳其语、英语、德语、法语、西班牙语、阿拉伯语、俄语、葡萄牙语、意大利语、日语、韩语、中文、荷兰语、波兰语、瑞典语、印地语、泰语和印尼语。" },
  ...
  nl: [
    ...
    { q: "Waar en in welke talen kan ik Qulo gebruiken?", a: "Qulo werkt overal waar de App Store of Google Play beschikbaar is. De app is er in 18 talen: Turks, Engels, Duits, Frans, Spaans, Arabisch, Russisch, Portugees, Italiaans, Japans, Koreaans, Chinees, Nederlands, Pools, Zweeds, Hindi, Thai en Indonesisch." },
  ...
  pl: [
    ...
    { q: "Gdzie i w jakich językach mogę korzystać z Qulo?", a: "Qulo działa wszędzie tam, gdzie dostępne są App Store lub Google Play. Aplikacja jest w 18 językach: tureckim, angielskim, niemieckim, francuskim, hiszpańskim, arabskim, rosyjskim, portugalskim, włoskim, japońskim, koreańskim, chińskim, niderlandzkim, polskim, szwedzkim, hindi, tajskim i indonezyjskim." },
  ...
  sv: [
    ...
    { q: "Var och på vilka språk kan jag använda Qulo?", a: "Qulo fungerar överallt där App Store eller Google Play finns. Appen är på 18 språk: turkiska, engelska, tyska, franska, spanska, arabiska, ryska, portugisiska, italienska, japanska, koreanska, kinesiska, nederländska, polska, svenska, hindi, thailändska och indonesiska." },
  ...
  hi: [
    ...
    { q: "Qulo कहाँ और किन भाषाओं में इस्तेमाल कर सकते हैं?", a: "जहाँ भी App Store या Google Play उपलब्ध है, वहाँ Qulo चलता है। ऐप 18 भाषाओं में है: तुर्की, अंग्रेज़ी, जर्मन, फ़्रेंच, स्पेनिश, अरबी, रूसी, पुर्तगाली, इतालवी, जापानी, कोरियाई, चीनी, डच, पोलिश, स्वीडिश, हिंदी, थाई और इंडोनेशियाई।" },
  ...
  th: [
    { q: "Qulo คืออะไร?", a: "Qulo คือแอปหาคู่ที่คุณแมตช์กันด้วยการตอบคำถามแทนการปัด สมาชิกทุกคนเขียนคำถามปรนัยเกี่ยวกับตัวเอง 2 ถึง 4 ข้อ — สูงสุด 10 ข้อในแพลนแบบชำระเงิน — ข้อละ 4 ตัวเลือก และเลือกคำตอบที่ถูก คุณแมตช์กับคนที่ตอบถูกทุกข้อ" },
    { q: "ใช้ Qulo ได้ที่ไหน และรองรับภาษาอะไรบ้าง?", a: "Qulo ใช้ได้ทุกที่ที่มี App Store หรือ Google Play แอปรองรับ 18 ภาษา: ตุรกี อังกฤษ เยอรมัน ฝรั่งเศส สเปน อาหรับ รัสเซีย โปรตุเกส อิตาลี ญี่ปุ่น เกาหลี จีน ดัตช์ โปแลนด์ สวีเดน ฮินดี ไทย และอินโดนีเซีย" },
    { q: "ใครอยู่เบื้องหลัง Qulo?", a: "Qulo สร้างและดูแลโดย Berkant Çalıkuşu นักพัฒนาอิสระในอิสตันบูล ประเทศตุรกี ผู้ก่อตั้งในปี 2026 เขาเป็นผู้ควบคุมข้อมูลตามนโยบายความเป็นส่วนตัว และติดต่อได้ที่ info@socrepho.com" },
    { q: "Qulo ต่างจากแอปหาคู่อื่นอย่างไร?", a: "เงื่อนไขของการแมตช์ ในแอปแบบปัด คนสองคนแมตช์กันเพราะชอบรูปของกันและกัน ใน Qulo ใครสักคนเข้าถึงคุณได้ด้วยการตอบคำถามที่คุณเขียนเกี่ยวกับตัวเองให้ถูกทุกข้อ ไม่มีคะแนนบางส่วน ไม่มีเปอร์เซ็นต์ ไม่มีการจัดอันดับ" },
  ],
  id: [
    { q: "Apa itu Qulo?", a: "Qulo adalah aplikasi kencan tempat kamu cocok dengan menjawab pertanyaan, bukan menggeser. Setiap anggota menulis 2 sampai 4 pertanyaan pilihan ganda tentang dirinya — hingga 10 di paket berbayar — masing-masing empat pilihan, dan menandai jawaban yang benar. Kamu cocok dengan siapa pun yang menjawab semuanya dengan benar." },
    { q: "Di mana Qulo bisa dipakai, dan dalam bahasa apa saja?", a: "Qulo berjalan di mana pun App Store atau Google Play tersedia. Aplikasinya tersedia dalam 18 bahasa: Turki, Inggris, Jerman, Prancis, Spanyol, Arab, Rusia, Portugis, Italia, Jepang, Korea, Mandarin, Belanda, Polandia, Swedia, Hindi, Thai, dan Indonesia." },
    { q: "Siapa di balik Qulo?", a: "Qulo dibuat dan dijalankan oleh Berkant Çalıkuşu, pengembang independen yang berbasis di Istanbul, Turki, yang mendirikannya pada 2026. Ia juga pengendali data yang disebut dalam kebijakan privasi, dan pertanyaan bisa dikirim ke info@socrepho.com." },
    { q: "Apa yang membuat Qulo berbeda dari aplikasi kencan lain?", a: "Syarat kecocokannya. Di aplikasi berbasis geser, dua orang cocok karena saling menyukai foto; di Qulo seseorang menjangkaumu dengan menjawab benar setiap pertanyaan yang kamu tulis tentang dirimu. Tidak ada nilai sebagian, tidak ada persentase, tidak ada peringkat." },
  ],
};
