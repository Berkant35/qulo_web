...
export const PAGE_SEO: Record<string, Record<string, { title: string; description: string }>> = {
  ...
  testimonials: {
    tr: { title: "Kullanıcı Yorumları — Qulo | 4.8/5 Puan", description: "Qulo kullanıcılarının gerçek deneyimleri. 12 detaylı yorum, 1247 toplam değerlendirme." },
    en: { title: "User Reviews — Qulo | 4.8/5 Rating", description: "Real experiences from Qulo users. 12 detailed reviews, 1247 total ratings." },
    de: { title: "Nutzerbewertungen — Qulo", description: "Echte Erfahrungen von Qulo-Nutzern." },
    fr: { title: "Avis Utilisateurs — Qulo", description: "Vraies expériences d'utilisateurs Qulo." },
    es: { title: "Opiniones de Usuarios — Qulo", description: "Experiencias reales de usuarios Qulo." },
    ar: { title: "آراء المستخدمين — Qulo", description: "تجارب حقيقية من مستخدمي Qulo." },
    ru: { title: "Отзывы пользователей — Qulo", description: "Настоящие впечатления пользователей Qulo." },
    pt: { title: "Avaliações dos Usuários — Qulo", description: "Experiências reais dos usuários Qulo." },
    it: { title: "Recensioni Utenti — Qulo", description: "Esperienze reali degli utenti Qulo." },
    ja: { title: "ユーザーレビュー — Qulo", description: "Quloユーザーの実際の体験談。" },
    ko: { title: "사용자 리뷰 — Qulo", description: "Qulo 사용자들의 실제 경험담." },
    zh: { title: "用户评论 — Qulo", description: "Qulo用户的真实体验。" },
    nl: { title: "Gebruikersbeoordelingen — Qulo", description: "Echte ervaringen van Qulo-gebruikers." },
    pl: { title: "Opinie Użytkowników — Qulo", description: "Prawdziwe doświadczenia użytkowników Qulo." },
    sv: { title: "Användarrecensioner — Qulo", description: "Verkliga upplevelser från Qulo-användare." },
    hi: { title: "उपयोगकर्ता समीक्षाएं — Qulo", description: "Qulo उपयोगकर्ताओं के वास्तविक अनुभव।" },
  },
  sitemap: {
