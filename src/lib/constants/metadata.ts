...
export const FAQ_DATA: Record<string, { q: string; a: string }[]> = {
  tr: [
    ...
    { q: "Hangi ülkelerde kullanılabilir?", a: "Qulo dünya genelinde kullanılabilir. 18 farklı dilde destek sunuyoruz." },
  ],
  en: [
    ...
    { q: "Which countries is Qulo available in?", a: "Qulo is available worldwide. We support 18 different languages." },
  ],
  de: [
    ...
    { q: "In welchen Ländern ist Qulo verfügbar?", a: "Qulo ist weltweit verfügbar. Wir unterstützen 18 verschiedene Sprachen." },
  ],
  fr: [
    ...
    { q: "Dans quels pays Qulo est-il disponible ?", a: "Qulo est disponible dans le monde entier. Nous prenons en charge 18 langues différentes." },
  ],
  es: [
    ...
    { q: "¿En qué países está disponible Qulo?", a: "Qulo está disponible en todo el mundo. Damos soporte a 18 idiomas diferentes." },
  ],
  ar: [
    ...
    { q: "في أي البلدان يتوفر Qulo؟", a: "يتوفر Qulo في جميع أنحاء العالم. ندعم 18 لغة مختلفة." },
  ],
  ja: [
    ...
    { q: "どの国で利用できますか？", a: "Quloは世界中で利用できます。18の言語に対応しています。" },
  ],
  ko: [
    ...
    { q: "어느 나라에서 이용할 수 있나요?", a: "Qulo는 전 세계에서 이용할 수 있습니다. 18개 언어를 지원합니다." },
  ],
  zh: [
    ...
    { q: "哪些国家可以使用？", a: "Qulo在全球范围内均可使用。我们支持18种不同的语言。" },
  ],
  ru: [
    ...
    { q: "В каких странах доступен Qulo?", a: "Qulo доступен по всему миру. Мы поддерживаем 18 разных языков." },
  ],
  pt: [
    ...
    { q: "Em quais países o Qulo está disponível?", a: "O Qulo está disponível no mundo todo. Oferecemos suporte a 18 idiomas diferentes." },
  ],
  it: [
    ...
    { q: "In quali paesi è disponibile Qulo?", a: "Qulo è disponibile in tutto il mondo. Supportiamo 18 lingue diverse." },
  ],
  nl: [
    ...
    { q: "In welke landen is Qulo beschikbaar?", a: "Qulo is wereldwijd beschikbaar. We ondersteunen 18 verschillende talen." },
  ],
  pl: [
    ...
    { q: "W jakich krajach Qulo jest dostępne?", a: "Qulo jest dostępne na całym świecie. Obsługujemy 18 różnych języków." },
  ],
  sv: [
    ...
    { q: "I vilka länder finns Qulo?", a: "Qulo finns tillgängligt över hela världen. Vi stöder 18 olika språk." },
  ],
  hi: [
    ...
    { q: "यह किन देशों में उपलब्ध है?", a: "Qulo दुनिया भर में उपलब्ध है। हम 18 अलग-अलग भाषाओं का समर्थन करते हैं।" },
  ],
  id: [
    ...
    { q: "Di negara mana saja Qulo tersedia?", a: "Qulo tersedia di seluruh dunia. Kami mendukung 18 bahasa." },
  ],
  th: [
    ...
    { q: "Qulo ใช้ได้ในประเทศไหนบ้าง?", a: "Qulo ใช้ได้ทั่วโลก เรารองรับ 18 ภาษา" },
  ],
};
...
export const PAGE_SEO: Record<string, Record<string, { title: string; description: string }>> = {
  ...
  communityGuidelines: {
    ...
    th: { title: "กฎของชุมชน — Qulo", description: "กฎที่ทำให้ Qulo ปลอดภัย: สิ่งที่เราคาดหวัง สิ่งที่ไม่อนุญาต และจะเกิดอะไรขึ้นเมื่อมีคนล้ำเส้น" },
    id: { title: "Pedoman Komunitas — Qulo", description: "Aturan yang menjaga Qulo tetap aman: apa yang kami harapkan, apa yang tidak diizinkan, dan apa yang terjadi saat seseorang melewati batas." },
  },
  safetyTips: {
    ...
    th: { title: "เคล็ดลับความปลอดภัย — Qulo", description: "วิธีปลอดภัยบน Qulo: สังเกตการหลอกลวง ปกป้องข้อมูลส่วนตัว และนัดเจอตัวจริงอย่างปลอดภัย" },
    id: { title: "Tips Keamanan — Qulo", description: "Cara tetap aman di Qulo: mengenali penipuan, melindungi informasi pribadimu, dan bertemu langsung dengan aman." },
  },
  help: {
  ...
  questions: {
    tr: { title: "Tanışma Uygulaması Soruları — Ne Sorulur, Nasıl Yazılır | Qulo", description: "Tanışma uygulamasında ne sorulur ve işe yarayan soru nasıl yazılır: dört seçenek kuralı, kaçınılması gerekenler ve 22 örnek soru." },
    en: { title: "Dating App Questions to Ask — and How to Write Yours | Qulo", description: "What to ask on a dating app and how to write questions people can actually answer: the four options, what to avoid, and 22 examples in your language." },
    de: { title: "Fragen für Dating-Apps — was fragen, wie schreiben | Qulo", description: "Was du in einer Dating-App fragst und wie du Fragen schreibst, die sich beantworten lassen: die vier Optionen, typische Fehler und 22 Beispiele." },
    fr: { title: "Questions pour app de rencontre — quoi demander | Qulo", description: "Quoi demander sur une app de rencontre et comment écrire des questions auxquelles on peut répondre : les quatre options, les pièges et 22 exemples." },
    es: { title: "Preguntas para apps de citas — qué preguntar y cómo | Qulo", description: "Qué preguntar en una app de citas y cómo escribir preguntas que se puedan responder: las cuatro opciones, los errores típicos y 22 ejemplos." },
    ar: { title: "أسئلة تطبيقات المواعدة — ماذا تسأل وكيف تكتبها | Qulo", description: "ماذا تسأل في تطبيق مواعدة وكيف تكتب أسئلة يمكن الإجابة عنها: قاعدة الخيارات الأربعة، والأخطاء الشائعة، و22 مثالاً." },
    ru: { title: "Вопросы для приложений знакомств — что спросить | Qulo", description: "Что спросить в приложении знакомств и как написать вопрос, на который можно ответить: правило четырёх вариантов, типичные ошибки и 22 примера." },
    pt: { title: "Perguntas para apps de namoro — o que perguntar | Qulo", description: "O que perguntar num app de namoro e como escrever perguntas que dá para responder: a regra das quatro opções, os erros comuns e 22 exemplos." },
    it: { title: "Domande per app di incontri — quali fare e come | Qulo", description: "Cosa chiedere su un'app di incontri e come scrivere domande a cui si possa rispondere: la regola delle quattro opzioni, gli errori tipici e 22 esempi." },
    ja: { title: "マッチングアプリの質問 — 何を聞き、どう書くか | Qulo", description: "マッチングアプリで何を聞くか、答えられる質問をどう書くか。四つの選択肢のルール、避けたい質問、そして22の質問例。" },
    ko: { title: "데이팅 앱 질문 — 무엇을 묻고 어떻게 쓸까 | Qulo", description: "데이팅 앱에서 무엇을 묻고, 답할 수 있는 질문을 어떻게 쓰는지. 선택지 네 개의 원칙, 피해야 할 질문, 그리고 22가지 예시." },
    zh: { title: "约会应用的问题 — 问什么，怎么写 | Qulo", description: "在约会应用里该问什么，以及怎么写出别人答得出来的问题：四个选项的规则、要避开的写法，还有 22 个示例。" },
    nl: { title: "Vragen voor datingapps — wat vraag je en hoe | Qulo", description: "Wat je vraagt in een datingapp en hoe je vragen schrijft die te beantwoorden zijn: de vier opties, veelgemaakte fouten en 22 voorbeelden." },
    pl: { title: "Pytania w aplikacjach randkowych — o co i jak pytać | Qulo", description: "O co pytać w aplikacji randkowej i jak napisać pytanie, na które da się odpowiedzieć: zasada czterech odpowiedzi, typowe błędy i 22 przykłady." },
    sv: { title: "Frågor i dejtingappar — vad du frågar och hur | Qulo", description: "Vad du frågar i en dejtingapp och hur du skriver frågor som går att svara på: regeln om fyra alternativ, vanliga misstag och 22 exempel." },
    hi: { title: "डेटिंग ऐप के सवाल — क्या पूछें और कैसे लिखें | Qulo", description: "डेटिंग ऐप पर क्या पूछें और ऐसे सवाल कैसे लिखें जिनका जवाब दिया जा सके: चार विकल्पों का नियम, आम गलतियाँ और 22 उदाहरण।" },
  },
  advice: {
