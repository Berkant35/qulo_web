...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: { title: `Child Safety Standards – ${SITE_NAME}`, description: "Qulo's CSAE prevention policy and safety standards.", url: pageUrl, siteName: SITE_NAME, type: "website" },
  };
}
